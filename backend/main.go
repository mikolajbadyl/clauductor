...
func main() {
	...
	r.GET("/api/claude-path", claudePathHandler)
	r.POST("/api/claude-path", claudePathHandler)
	r.POST("/api/claude-update", claudeUpdateHandler)
	r.GET("/api/clauductor-version", clauductorVersionHandler)
	r.POST("/api/clauductor-update", clauductorUpdateHandler)
